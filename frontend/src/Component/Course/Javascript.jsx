                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-8'>
                                        ...
                                        <div className="sub-heading ">
                                            <p>Join the program and get the opportunity to learn under the guidance of an Javascript specialist.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
