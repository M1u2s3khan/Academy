                           ...
                           <div className="row align-items-center d-flex">
                               ...
                               <div className="col-md-8">
                                       ...
                                       <div className='row'>
                                           <div className='col-lg-4'>
                                               <div className='category-mobile-image img'>
                                                   <img width={250} height={150} src="images/userinterface.png" alt="Java" className='img-fluid' />
                                               </div>
                                           </div>
                                           <div className='col-lg-8'>
                                               <h5>UI Designer</h5>
                                               <div className="sub-heading ">
                                                   <p>Join the program and get the opportunity to learn under the guidance of an UI Designer.</p>
                                               </div>
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div className="course-banner-sections-left">
                                      ...
                                      <p>A UI (User Interface) designer focuses on creating the visual elements and interactive components of a website, app, or other digital product to ensure a user-friendly and engaging experience. They design how users interact with the product, including elements like buttons, menus, and overall visual style. </p>
                                   </div>
                               </div>
