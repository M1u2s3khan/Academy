                    ...
                    <div className="row align-items-center d-flex">
                        ...
                        <div className="col-md-8">
                                ...
                                <div className='row'>
                                    <div className='col-lg-4'>
                                        <div className='category-mobile-image img'>
                                            <img width={150} height={150} src="images/react1.png" alt="Java" className='img-fluid' />
                                        </div>
                                    </div>
                            ...
                            <div className="course-banner-sections-left">
                                ...
                                <p className="cat_desc">Ever wondered how websites seamlessly react to your clicks and deliver dynamic content? That's the magic of React JS, a powerful JavaScript library that's become a superstar in web development. But how do you harness this magic and build interactive web applications like a pro?.
                                </p>
                            </div>
                        </div>
