// const contactRagistration = require('../model/contactRagistration');
const contactmasterform = require('../model/contactRagistration')
const mongoose = require("mongoose");
 exports.createcontact = async (req, res) => {
    try{
        ...
        const data = await contactmasterform.create({
            ...req.body,
            createdAt: new Date()
        });
        res.status(200).json({
